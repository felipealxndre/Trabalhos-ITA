...
aircraft.x_1 = -11.164;            % Left engine thrust action point x_b coordinate [m]
aircraft.y_1 = -4.2;            % Left engine thrust action point y_b coordinate [m]
aircraft.z_1 = 1.8715;            % Left engine thrust action point z_b coordinate [m]

aircraft.iota_2_deg = 2.0;     % Right engine incidence [deg]
aircraft.tau_2_deg = -1.5;      % Right engine toe-in angle [deg]
aircraft.x_2 = -11.164;            % Right engine thrust action point x_b coordinate [m]
aircraft.y_2 = 4.2;            % Right engine thrust action point y_b coordinate [m]
aircraft.z_2 = 1.8715;            % Right engine thrust action point z_b coordinate [m]
