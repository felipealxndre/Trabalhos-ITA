...
% Código MAIN.m referente a Questão 07 da Lista 03.
...
% Modelo linearizado da Questão 03
...
% Modelo simplificado de 2DOF

A_reduzido = A([7 10], [7 10]);
eig_red = eig(A_reduzido);
damp(eig_red);
