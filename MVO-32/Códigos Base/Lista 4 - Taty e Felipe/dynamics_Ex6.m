function [Xdot, Y] = dynamics_Ex6(t, X, U)
...
% 1. Aerodinâmica
[D, Y, L, l, m, n] = aero_loads_Ex6(X, U);
M_aero_b = [l; m; n];
...
F_grav_b = [-mass*g*sin(theta_rad);
             mass*g*cos(theta_rad)*sin(phi_rad);
             mass*g*cos(theta_rad)*cos(phi_rad)];
...
udot = F_total_b(1)/mass - q_rad_s*w + r_rad_s*v;
vdot = F_total_b(2)/mass - r_rad_s*u + p_rad_s*w;
wdot = F_total_b(3)/mass - p_rad_s*v + q_rad_s*u;
...
[CD, CY, CL, Cl, Cm, Cn] = aero_databank_Ex6(X, U);
