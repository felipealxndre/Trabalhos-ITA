...
C_tau_p_1 = [ cosd(aircraft.tau_1_deg)  sind(aircraft.tau_1_deg)  0;
           -sind(aircraft.tau_1_deg)  cosd(aircraft.tau_1_deg)  0;
            0           0           1 ];

C_tau_p_2 = [ cosd(aircraft.tau_2_deg)  sin(aircraft.tau_2_deg)  0;
           -sind(aircraft.tau_2_deg)  cos(aircraft.tau_2_deg)  0;
            0           0           1 ];


% 2ª rotação: ângulo i_p em torno do eixo y do sistema intermediário
C_i_p_1 = [  cosd(aircraft.iota_1_deg)   0   -sind(aircraft.iota_1_deg);
           0          1    0;
           sind(aircraft.iota_1_deg)   0    cosd(aircraft.iota_1_deg) ];

C_i_p_2 = [  cosd(aircraft.iota_2_deg)   0   -sind(aircraft.iota_2_deg);
           0          1    0;
           sind(aircraft.iota_2_deg)   0    cosd(aircraft.iota_2_deg) ];
